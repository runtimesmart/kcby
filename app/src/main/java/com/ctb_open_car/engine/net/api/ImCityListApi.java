...
public class ImCityListApi extends BaseApi {
    private HashMap<String, Object> mQueryMap = new HashMap<>();

    public ImCityListApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getAreaCodeList(mQueryMap);
    }
