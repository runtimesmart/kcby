...
public class GroupHotListApi extends BaseApi {

    private HashMap mBody;


    public GroupHotListApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getHotGroupList(mBody);
    }
