...
public class VehicleToolsApi extends BaseApi {
    private HashMap<String, Object> mQueryMap = new HashMap<>();

    public VehicleToolsApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getVehicleTools(mQueryMap);
