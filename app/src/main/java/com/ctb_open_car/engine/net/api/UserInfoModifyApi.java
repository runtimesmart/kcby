...
public class UserInfoModifyApi extends BaseApi {
    private HashMap mBody;

    public UserInfoModifyApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.userInfoModify(mBody);
    }
