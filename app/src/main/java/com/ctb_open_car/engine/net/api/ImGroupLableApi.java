...
public class ImGroupLableApi extends BaseApi {
    private HashMap<String, Object> mQueryMap = new HashMap<>();

    public ImGroupLableApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getImGroupLable(mQueryMap);
    }
