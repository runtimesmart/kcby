...
public class FeedDetailCommentApi extends BaseApi {

    private HashMap mBody;

    public FeedDetailCommentApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getFeedComments(mBody);
    }
