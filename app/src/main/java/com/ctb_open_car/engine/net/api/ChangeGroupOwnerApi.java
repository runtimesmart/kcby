...
public class ChangeGroupOwnerApi extends BaseApi {
    private HashMap mBody;

    public ChangeGroupOwnerApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.changeMyGroupOwner(mBody);
    }
