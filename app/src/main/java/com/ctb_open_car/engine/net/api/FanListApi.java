...
public class FanListApi extends BaseApi {

    private HashMap mBody;


    public FanListApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getFanList(mBody);
    }
