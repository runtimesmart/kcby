...
public class SendValidateCodeApi extends BaseApi {
    private HashMap<String, Object> mQueryMap = new HashMap<>();

    public SendValidateCodeApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.sendValidateCode(mQueryMap);
    }
