...
public class CreateImGroupApi extends BaseApi {
    private HashMap<String, Object> mQueryMap = new HashMap<>();

    public CreateImGroupApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.createImGroup(mQueryMap);
    }
