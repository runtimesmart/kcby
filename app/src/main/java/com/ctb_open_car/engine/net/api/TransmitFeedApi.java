...
public class TransmitFeedApi extends BaseApi {

    private HashMap mBody;

    public TransmitFeedApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.transmitFeed(mBody);
    }
