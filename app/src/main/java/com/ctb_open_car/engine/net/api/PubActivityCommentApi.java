...
public class PubActivityCommentApi extends BaseApi {

    private HashMap mBody;

    public PubActivityCommentApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.publishActivigtyComments(mBody);
    }
