...
public class FeedDeleteApi extends BaseApi {

    private HashMap mBody;


    public FeedDeleteApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.deleteFeed(mBody);
    }
