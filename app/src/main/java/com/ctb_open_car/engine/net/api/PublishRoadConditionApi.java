...
public class PublishRoadConditionApi extends BaseApi {
    private HashMap<String, Object> mQueryMap = new HashMap<>();

    public PublishRoadConditionApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.publishRoadConditionPost(mQueryMap);
    }
