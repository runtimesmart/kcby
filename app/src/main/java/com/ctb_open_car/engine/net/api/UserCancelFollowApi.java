...
public class UserCancelFollowApi extends BaseLikeApi {
    private HashMap mBody;

    public UserCancelFollowApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.userCancelFollow(mBody);
    }
