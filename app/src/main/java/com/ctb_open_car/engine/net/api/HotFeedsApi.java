...
public class HotFeedsApi extends BaseApi {
    private HashMap mBody;

    public HotFeedsApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getHotFeedList(mBody);
    }
