...
public class PersonHotFeedsApi extends BaseApi {
    private HashMap mBody;

    public PersonHotFeedsApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getPersonFeedList(mBody);
    }
