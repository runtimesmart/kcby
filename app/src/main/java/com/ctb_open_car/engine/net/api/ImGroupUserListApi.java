...
public class ImGroupUserListApi extends BaseApi {
    private HashMap<String, Object> mQueryMap = new HashMap<>();

    public ImGroupUserListApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getGroupUserList(mQueryMap);
    }
