...
public class FocusListApi extends BaseApi {

    private HashMap mBody;


    public FocusListApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getFocusList(mBody);
    }
