...
public class ImGroupDetailsApi extends BaseApi {
    private HashMap<String, Object> mQueryMap = new HashMap<>();

    public ImGroupDetailsApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getGroupDetails(mQueryMap);
    }
