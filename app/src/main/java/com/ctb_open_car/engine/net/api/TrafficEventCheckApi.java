...
public class TrafficEventCheckApi extends BaseLikeApi {
    private HashMap mBody;

    public TrafficEventCheckApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.trafficEventCheck(mBody);
    }
