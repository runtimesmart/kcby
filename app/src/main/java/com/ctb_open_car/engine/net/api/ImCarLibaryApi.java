...
public class ImCarLibaryApi extends BaseApi {
    private HashMap<String, Object> mQueryMap = new HashMap<>();

    public ImCarLibaryApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getCarLibary();
    }
