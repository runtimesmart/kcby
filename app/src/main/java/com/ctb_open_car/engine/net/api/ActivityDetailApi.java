...
public class ActivityDetailApi extends BaseApi {

    private HashMap mBody;

    public ActivityDetailApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getActivityDetail(mBody);
    }
