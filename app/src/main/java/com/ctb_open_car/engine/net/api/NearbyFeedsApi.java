...
public class NearbyFeedsApi extends BaseApi {
    private HashMap mBody;

    public NearbyFeedsApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getNearbyFeedList(mBody);
    }
