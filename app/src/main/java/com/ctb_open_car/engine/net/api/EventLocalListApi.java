...
public class EventLocalListApi extends BaseApi {

    private HashMap mBody;


    public EventLocalListApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.getLocalEventsList(mBody);
    }
