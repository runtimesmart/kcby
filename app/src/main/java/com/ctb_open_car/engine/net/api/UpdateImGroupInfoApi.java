...
public class UpdateImGroupInfoApi extends BaseApi {
    private HashMap<String, Object> mQueryMap = new HashMap<>();

    public UpdateImGroupInfoApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return mRequestInterface.modifyGroupInfo(mQueryMap);
    }

    public void setRequestBody(HashMap mapBody) {
        this.mQueryMap = mapBody;
    }
