...
public class TagView extends ViewGroup {
    ...
    public TagView(Context context, AttributeSet attrs) {
        ...
        if (attrArray != null) {
            childHorizontalSpace = attrArray.getDimensionPixelSize(R.styleable.TagsLayout_tagview_HorizontalSpace, 0);
            childVerticalSpace = attrArray.getDimensionPixelSize(R.styleable.TagsLayout_tagview_VerticalSpace, 0);
            attrArray.recycle();
        }
    }
