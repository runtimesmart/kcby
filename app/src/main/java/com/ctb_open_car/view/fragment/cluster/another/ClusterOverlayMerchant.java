...
public class ClusterOverlayMerchant {
    private AMap mAMap;
    private Context mContext;
    private List<ClusterItem> mClusterItems;
    private List<Cluster> mClusters;
    private int mClusterSize;
    private ClusterAnotherClickListener mClusterClickListener;
    private ClusterAnotherRender mClusterRender;
     ...
     * @param context
     */
    public ClusterOverlayMerchant(AMap amap, int clusterSize, Context context) {
     ...
     * @param context
     */
    public ClusterOverlayMerchant(AMap amap, List<ClusterItem> clusterItems,
     ...
     */
    public void setOnClusterAnotherClickListener(ClusterAnotherClickListener clusterClickListener) {
     ...
     * @param render
     */
    public void setClusterAnotherRenderer(ClusterAnotherRender render) {
    ...
    public void responseClusterClickEvent(Marker arg0){
        ...
        if(cluster!=null){
            mClusterClickListener.onAnotherClick(arg0,cluster.getClusterItems());
        }
    }
