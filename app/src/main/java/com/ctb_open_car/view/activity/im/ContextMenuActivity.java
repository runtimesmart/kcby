...
public class ContextMenuActivity extends Activity {
	...
	public static final int RESULT_CODE_COMPLAIN = 5;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (type == EMMessage.Type.TXT.ordinal()) {
		    if(message.getBooleanAttribute(AppContraint.EMCHAT.MESSAGE_ATTR_IS_VIDEO_CALL, false)
					|| message.getBooleanAttribute(AppContraint.EMCHAT.MESSAGE_ATTR_IS_VOICE_CALL, false)){
				setContentView(R.layout.em_context_menu_for_location);
		    }else if(message.getBooleanAttribute(AppContraint.EMCHAT.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
	...
	public void complain(View view){
		setResult(RESULT_CODE_COMPLAIN);
		finish();
	}
