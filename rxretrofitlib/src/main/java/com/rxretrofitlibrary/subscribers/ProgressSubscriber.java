...
import com.rxretrofitlibrary.exception.HttpTimeException;
...
//        showProgressDialog();
        /*缓存并且有网*/
        if (api.isCache() && AppUtil.isNetworkAvailable(RxRetrofitApp.Singleton.INSTANCE.get().getApplication())) {
             /*获取缓存数据*/
    ...
    private void errorDo(Throwable e) {
        ...
        if (e instanceof SocketTimeoutException) {
            ...
            Log.e("CTB", "提示：" + e.getMessage());
           // Toast.makeText(context, "提示：" + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
        if (mSubscriberOnNextListener.get() != null) {
