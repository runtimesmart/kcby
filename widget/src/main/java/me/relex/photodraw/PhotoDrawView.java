...
public class PhotoDrawView extends SimpleDraweeView implements IAttacher {

    private Attacher mAttacher;

    public PhotoDrawView(Context context, GenericDraweeHierarchy hierarchy) {
    ...
    public PhotoDrawView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setPhotoViewRotation(float degrees) {
        mAttacher.setPhotoViewRotation(degrees);
    }
