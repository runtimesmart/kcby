...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    private RightLayoutClickListener mRightLayoutClickListener;
    ...
    public void setRightLayoutClickListener(RightLayoutClickListener layoutClickListener){
        mRightLayoutClickListener=layoutClickListener;
    }
    public void setTypeListener(TypingListener listener){
        this.mTypingListener=listener;
    }
    /**
     * init view
     */
...
//        messageList.setAvatarShape(1);
        ...
        inputMenu.setChatInputMenuListener(new ChatInputMenuListener() {
            ...
            public void onTyping(CharSequence s, int start, int before, int count) {
                ...
                mTypingListener.onTyping(s,start,before,count);
            }
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            titleBar.setRightImageResource(R.drawable.icon_detail);
        ...
        titleBar.setRightLayoutClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (chatType == EaseConstant.CHATTYPE_SINGLE) {
                    ...
                    mRightLayoutClickListener.OnRightClickListener(v);
                    toGroupDetails();
                }
            }
        });
    ...
    public interface RightLayoutClickListener{
        ...
        rxPermissions.request(Manifest.permission.CAMERA).subscribe(new io.reactivex.functions.Consumer<Boolean>() {
            ...
            public void accept(Boolean aBoolean) throws Exception {
                if (aBoolean) {
                    ...
                    Toasty.info(getContext(), "此应用需访问相机权限，请检查");
                }
            }
        });
