...
public class EaseTitleBar extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mRightText = findViewById(R.id.right_txt);
        mRightTextLayout = (RelativeLayout) findViewById(R.id.right_layout_txt);
    ...
    public void setRightTxt(String resTxt) {
        mRightTextLayout.setVisibility(VISIBLE);
        rightLayout.setVisibility(GONE);
        mRightText.setText(resTxt);
    }

    public void setRightTxtVisibile(int visibile) {
        mRightTextLayout.setVisibility(visibile);
    }
